              ...
              <div className="flex items-center justify-between  p-1  ">
                ...
                <div className="md:flex  w-full justify-between ">
                  ...
                  <div className="md:flex md:space-y-0 space-y-2 mx-auto md:mx-0  gap-4 ">
                    ...
                    <div className="px-3 flex justify-around bg-success text-white  gap-2 items-center md:py-1.5 py-1 font-larze  border border-success  focus:ring-4 focus:outline-none  rounded-md ">
...
{/* ---------------Start---------------------- */}
 ...
 <select className="flex h-10 w-full rounded-md border border-gray bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-success focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50">
                  ...
                  <div className="mt-2">
                    ...
                    <button type="button" onClick={MytoggleMenu} className="px-5 bg-white flex justify-between w-full  gap-2 items-center py-2.5  font-larze text-success border border-gray  focus:outline-none focus:ring-1 focus:ring-success focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 focus:outline-none  rounded-md ">
                    ...
                    {
                      calender && <div className=' z-20  bg-white absolute top-80 left-110'>
                        <Calendar />
                      </div>
                    }
