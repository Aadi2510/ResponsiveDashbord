                ...
                <div className="  text-neutral-600 mx-auto text-md antialiased font-normal  p-5   ">
                    ...
                    <div className=" p-2 relative top-5 my-5 mt-5 antialiased">
                        <div className="text-xl md:py-5 py-3">Dashboard /
                            <span className='text-gray font-semibold'>Employees /</span>
                                        ...
                                        <div className="  ">
                                            ...
                                            <div className=" md:flex justify-between w-full ">
                                                ...
                                                <div className="p-3 md:flex gap-3  ms-auto space-y-3 md:space-y-0  ">
                                                    ...
                                                    <Link to="/admin/employees/viewemployees/employeesaddress/addresscategory" className="px-3  flex justify-around md:w-fit w-full gap-2 ms-auto items-center py-1.5  font-larze text-white bg-success  focus:ring-4 focus:outline-none  rounded-md ">
                                                    <CiCirclePlus className='size-5 ' />
                                                        <button type="submit" >
                                                            Add Category
                                                        </button>
